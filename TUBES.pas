...
var
        ...
        i,j,o,e:integer;
        total:longint;
        anslist,nama_costumer,search:string;
        ...
        procedure pembelianapartemen(var trans:transaksi; ap:apartemen;var max_t:integer;max_ap:integer;var jum:longint);
        var
          x:string;
          z,n,kluar,i:integer;
        begin
